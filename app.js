...
const menuPanel = document.querySelector('.menu-list'); // Määrame muutujale menuPanel HTML-element, mille klass on menu-panel
const menuLinks = document.querySelectorAll('.menu-list a'); // Määrame muutujale menuLinks kõik HTML-sildid, mis asuvad menüü paneeli sees
